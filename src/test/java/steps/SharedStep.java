...
public class SharedStep extends BasePage{
	...
	{
		ExtentSparkReporter sparkreporter = new ExtentSparkReporter("NewArrival.html");
	...
	{
		extentreports.flush();
		Desktop.getDesktop().browse(new File("NewArrival.html").toURI());
	}
	@AfterMethod
	public void generateTestStatus(Method m,ITestResult result) throws IOException
	{
		if(result.getStatus() == ITestResult.FAILURE )
		{
			...
			File destFile=new File("./screenshots/NewArrival.png");
